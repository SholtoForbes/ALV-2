...
% For equation definitions see 'SIMPLE METHOD FOR PERFORMANCE EVALUATION OF
% MULTISTAGE ROCKETS' by Pontani & Teofilatto eqs 6-11 & 'Equations of
% Powered Rocket Ascent and Orbit Trajectory' by Reilly
...
vdot = T*cos(alpha)/(m) - mu_E*sin(gamma)/r^2 -D/m + omega_E^2*r*cos(phi)*(cos(phi)*cos(gamma)+sin(phi)*sin(gamma)*sin(zeta)); % This is different to the equation found in Pontani &  Teofilatto, v removed
