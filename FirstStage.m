...
mRocket = 480 + mFuel + 100*SCALE^3; %(kg)  %Total lift-off mass, ALV-2 with scaling
% NOTE scale is of engine characteristic length. It is assumed that the
% rocket inscreases in radius by an equilavent amount. Engine parameters
% and rocket area are scaled, but not total structural and fuel mass
